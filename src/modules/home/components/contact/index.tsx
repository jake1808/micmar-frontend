...
<p className=" text-2xl-regular text-gray-900 max-w-lg mb-4 text-center  ">Let’s chat and get a quote!</p>
...
<button className="mt-9 text-base font-semibold leading-none text-white py-4 px-10 bg-[#4F80C1] rounded hover:bg-indigo-600 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:outline-none">SUBMIT</button>
</div>
</div>
</div>
</div>
