...
<h1 className="  text-2xl-regular   text-white text-center">Don’t miss out!</h1>
<p className="text-base leading-normal text-center text-white mt-6">
Subscribe to our newsletter to stay in the loop. Gte latest news <br />on our latest products and services.
</p>
